  ...
  static List<Product> getProducts() {
    return [
      Product(
        ...
        description: 'High-quality dog food with balanced nutrition for adult dogs. Made with real chicken and vegetables.',
        price: 49.99,
      ...
      Product(
        ...
        description: 'Omega-3 rich salmon oil to support healthy skin and coat for your dog.',
        price: 24.99,
      ...
      Product(
        ...
        description: 'Grain-free wet food made with real beef and vegetables. No artificial preservatives.',
        price: 3.99,
      ...
      Product(
        ...
        description: 'Complete vitamin supplement designed for senior dogs to support joint health and immunity.',
        price: 29.99,
